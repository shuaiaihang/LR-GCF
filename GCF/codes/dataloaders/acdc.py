...
class ACDCDataSet(Dataset):
    ...
    def __init__(self, root_dir='data/ACDC', mode='train', num=None, transforms=None):
        ...
        names_file = f'{self.root_dir}/train_slices.list' if self.mode == 'train' else f'{self.root_dir}/test_slices.list' #test_val_slices.list
...
def get_acdc_loaders(root_dir='data/ACDC', labeled_num=7, labeled_bs=12, batch_size=24, batch_size_val=16,
