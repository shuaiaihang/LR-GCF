...
from codes.trainers import GCFTrainer


def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--config', type=str, default='configs/comparison_acdc_224_136/gcf_unet_r50.yaml',
...
def build_trainer(name,
                  ...
                  resume_from=None,
                  **kwargs):
    trainers = {'GCFTrainer': GCFTrainer}
    return trainers[name](logger=logger, device=device, data_parallel=data_parallel, ckpt_save_path=ckpt_save_path,
